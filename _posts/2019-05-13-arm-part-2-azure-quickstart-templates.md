...
Well, I found one in the quickstart: [https://azure.microsoft.com/en-us/resources/templates/101-webapp-basic-windows/](https://azure.microsoft.com/en-us/resources/templates/101-webapp-basic-windows/). From this quickstart, I can click Deploy to Azure, fill out some information and I've got an App Service Plan and a Web App. **This is so cool.** Now to tear this thing apart and figure out what it is.

## Ok, Lets play with an ARM Template

In the [github repo](https://github.com/Azure/azure-quickstart-templates/tree/master/101-webapp-basic-windows) it looks like there are 2 or 3 files that make up the ARM Template.

### Dissection

Lets dissect [azuredeploy.json](https://github.com/Azure/azure-quickstart-templates/blob/master/101-webapp-basic-windows/azuredeploy.json). Schema, version, blah...
