...
{{< figure src="/images/ms-teams-logo.png" alt="Microsoft Teams" class="float-right m-4" >}}
...
{{< figure src="/images/openai-logo.png" alt="OpenAI" class="mx-auto" >}}
