...
aliases:
- /conferences/ndc-security-2026/
slug: ndc-security-2026
---

![NDC Security 2026 - MITRE ATT&CK for Developers](/images/ndc-security-2026-mitre-attck-for-developers.jpg)

I'm excited to be speaking at [NDC Security 2026](https://ndcsecurity.com/) in Oslo, March 2-5! I'll be presenting **MITRE ATT&CK for Developers** — showing how developers can go beyond the OWASP Top 10 and use the ATT&CK framework to think like attackers and build stronger defenses.

<!--more-->

## About NDC Security

[NDC Security](https://ndcsecurity.com/) is a dedicated security conference for software developers, held at the Radisson Blu Scandinavia Hotel in Oslo. With 66 sessions and over 60 speakers, it bridges the gap between development and security — designed for developers who want to build secure software and security professionals who want to understand modern development practices.
...
For a preview, check out my blog post on [MITRE ATT&CK for Developers: Beyond OWASP](/posts/mitre-attack-framework/).
...
If you're attending NDC Security, come say hello! You can check out the full agenda and grab tickets at [ndcsecurity.com](https://ndcsecurity.com/).
