...
- /development/customizing-the-jekyll-theme/
slug: customizing-the-jekyll-theme
---
...
{{< figure src="/images/minimal-mistakes-layout-archive.png" >}}

Fortunately Archive also refers to Default so I can focus my changes there if I want to override it.

{{< figure src="/images/minimal-mistakes-layout-default.png" >}}
...
{{< figure src="/images/custom-footer.png" >}}

So lets set that!

{{< figure src="/images/mermaid-frontmatter.png" >}}
